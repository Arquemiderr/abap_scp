CLASS zcl_renting_load_data_a06 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_renting_load_data_a06 IMPLEMENTATION.


  METHOD if_oo_adt_classrun~main.
    DATA:   lt_brands       TYPE TABLE OF   zrent_a06_brands,
            lt_cars         TYPE TABLE OF   zrent_a06_cars,
            lt_customers    TYPE TABLE OF   zrent_a06_custom.
*    BRANDS
    lt_brands = VALUE #(
    ...
    INSERT zrent_a06_brands FROM TABLE @lt_brands.
    SELECT * FROM zrent_a06_brands INTO TABLE @lt_brands.
    out->write( sy-dbcnt ).
...
*    CARS
    ...
    DELETE FROM zrent_a06_cars.
    INSERT zrent_a06_cars FROM TABLE @lt_cars.
    SELECT * FROM zrent_a06_cars INTO TABLE @lt_cars.
    out->write( sy-dbcnt ).
...
*    CUSTOMERS
    ...
    DELETE FROM zrent_a06_custom.
    INSERT zrent_a06_custom FROM TABLE @lt_customers.
    SELECT * FROM zrent_a06_custom INTO TABLE @lt_customers.
    out->write( sy-dbcnt ).
    out->write( 'zrent_custom_arg data inserted succesfully!' ).
